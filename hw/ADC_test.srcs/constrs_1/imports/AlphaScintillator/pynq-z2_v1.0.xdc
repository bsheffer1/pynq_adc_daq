...
##BRS adding double ended inputs
#these are not the arduino analog inputs
set_property -dict { PACKAGE_PIN K9   IOSTANDARD LVCMOS33 } [get_ports { XADC_V_P  }]; #IO_L3P_T0_DQS_AD1P_35 Sch=ar_an0_p
set_property -dict { PACKAGE_PIN L10   IOSTANDARD LVCMOS33 } [get_ports { XADC_V_N  }]; #IO_L3P_T0_DQS_AD1P_35 Sch=ar_an0_n
