...
################################################################
# This is a generated script based on design: adc_interface
#
...
# source adc_interface_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set XADC_V_N [ create_bd_port -dir I XADC_V_N ]
  set XADC_V_P [ create_bd_port -dir I XADC_V_P ]
  set led [ create_bd_port -dir O -from 3 -to 0 led ]

  # Create instance: axi_registers, and set properties
  set block_name axi_registers
  set block_cell_name axi_registers
  if { [catch {set axi_registers [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_registers eq "" } {
...
0#Enet 0}\
  ...
  connect_bd_net -net xadc_wiz_0_m_axis_tvalid [get_bd_pins daq_0/s_axis_tvalid] [get_bd_pins xadc_wiz_0/m_axis_tvalid]
